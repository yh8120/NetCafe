...
<body class="pb-5">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown text-end"><a class="nav-link active dropdown-toggle" aria-current="page" href="#"
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item active text-end" aria-current="true" href="listRoom">ルーム管理</a></li>
    ...
    <div class="container">
    <div class="row mb-1">
        <div class="col-auto"><h2>ルームリスト</h2></div>
        <div class="col-auto"><a href="addRoom"><img src="images/add_button.svg" alt="" width="30" /></a></div>
    </div>
        <div class="row">
            <div class="col">
