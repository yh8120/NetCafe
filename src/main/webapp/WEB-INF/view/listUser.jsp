						...
						<tbody>
							<c:forEach items="${userList}" var="user">
								<tr>
									...
									<td><c:out value="${user.userClassName }" /></td>
									<td><a href="updateUser?userId=<c:out value="${user.userId }"/>">更新</a></td>
									<td><a href="deleteUser?userId=<c:out value="${user.userId }"/>">削除</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
